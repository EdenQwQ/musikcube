...
2. Copy `themes` to `~/.config/musikcube/`
3. Disable `degrade to 256 color palette` in musikcube settings
4. Under `color theme` in musikcube settings, enable catppuccin
5. Restart musikcube
